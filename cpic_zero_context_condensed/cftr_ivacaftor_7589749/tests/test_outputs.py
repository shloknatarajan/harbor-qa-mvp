...
EXPECTED_IMPLICATION = "CFTR: An individual diagnosed with cystic fibrosis (CF) and CFTR variants listed in the FDA-approved drug label as being responsive to ivacaftor"
DRUG = "ivacaftor"
GENE = "CFTR"
VARIANT = "CFTR ivacaftor responsive in CF patients"
