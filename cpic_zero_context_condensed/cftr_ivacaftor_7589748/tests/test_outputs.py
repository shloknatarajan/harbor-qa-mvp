...
EXPECTED_IMPLICATION = "CFTR: An individual diagnosed with cystic fibrosis (CF) and negative for a CFTR variant listed in the FDA-approved drug label as being responsive to ivacaftor."
DRUG = "ivacaftor"
GENE = "CFTR"
VARIANT = "CFTR ivacaftor non-responsive in CF patients"
