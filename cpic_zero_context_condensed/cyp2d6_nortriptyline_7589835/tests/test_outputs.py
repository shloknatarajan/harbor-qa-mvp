...
EXPECTED_RECOMMENDATION = "Consider a 25% reduction of recommended starting dose. Titrate dose to observed clinical response with symptom improvement and minimal (if any) side effects. Utilize therapeutic drug monitoring to guide dose adjustments."
EXPECTED_CLASSIFICATION = "Optional"
EXPECTED_IMPLICATION = "CYP2D6: Reduced metabolism of tricyclic antidepressants to less active compounds compared to normal metabolizers. Higher plasma concentrations of active drug will increase the probability of side effects."
DRUG = "nortriptyline"
GENE = "CYP2D6"
VARIANT = "CYP2D6 1.0"
