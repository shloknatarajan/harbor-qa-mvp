...
EXPECTED_RECOMMENDATION = "Avoid standard dose clopidogrel (75 mg) if possible. Use prasugrel or ticagrelor at standard dose if no contraindication."
EXPECTED_CLASSIFICATION = "Strong"
EXPECTED_IMPLICATION = "CYP2C19: Reduced clopidogrel active metabolite formation; increased on-treatment platelet reactivity; increased risk for adverse cardiac and cerebrovascular events"
DRUG = "clopidogrel"
GENE = "CYP2C19"
VARIANT = "CYP2C19 Likely Intermediate Metabolizer"
