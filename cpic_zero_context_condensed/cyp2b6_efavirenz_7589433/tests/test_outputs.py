...
EXPECTED_IMPLICATION = "CYP2B6: Higher dose-adjusted trough concentrations of efavirenz compared with normal metabolizers; increased risk of CNS adverse events"
DRUG = "efavirenz"
GENE = "CYP2B6"
VARIANT = "CYP2B6 Intermediate Metabolizer"
