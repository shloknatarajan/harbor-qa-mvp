...
EXPECTED_IMPLICATION = "CYP2C19: Increased clopidogrel active metabolite formation; lower on-treatment platelet reactivity; no association with higher bleeding risk"
DRUG = "clopidogrel"
GENE = "CYP2C19"
