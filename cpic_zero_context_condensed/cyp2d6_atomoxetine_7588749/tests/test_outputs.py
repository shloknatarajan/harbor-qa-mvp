...
EXPECTED_RECOMMENDATION = "Initiate with a dose of 40 mg/day and if no clinical response and in the absence of adverse events after 2 weeks increase dose to 80 mg/day. If response is inadequate after 2 weeks, consider obtaining a plasma concentration 2 to 4 hours after dosing. If concentration is <200 ng/mL, consider a proportional dose increase to achieve a concentration to approach 400 ng/mL. If unacceptable side effects are present at any time, consider a reduction in dose."
EXPECTED_CLASSIFICATION = "Moderate"
EXPECTED_IMPLICATION = "CYP2D6: Significantly decreased metabolism of atomoxetine may result in higher concentrations as compared to non-poor metabolizers. This may increase the occurrence of treatment-emergent side effects, but also a greater improvement of ADHD symptoms as compared to non-poor metabolizers in those who tolerate treatment. Poor metabolizer status is associated with lower final dose requirements as compared to non-poor metabolizers."
DRUG = "atomoxetine"
GENE = "CYP2D6"
VARIANT = "CYP2D6 0.0"
