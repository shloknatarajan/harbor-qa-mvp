...
EXPECTED_RECOMMENDATION = "Insufficient evidence demonstrating clinical impact based on CYP2D6 genotype. Initiate therapy with recommended starting dose."
EXPECTED_CLASSIFICATION = "No Recommendation"
EXPECTED_IMPLICATION = "CYP2D6: Very limited data available for CYP2D6 intermediate metabolizers"
DRUG = "ondansetron"
GENE = "CYP2D6"
VARIANT = "CYP2D6 1.0"
