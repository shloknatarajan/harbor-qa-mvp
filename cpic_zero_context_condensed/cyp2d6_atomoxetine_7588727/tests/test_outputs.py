...
EXPECTED_RECOMMENDATION = "Initiate with a dose of 0.5 mg/kg/day and if no clinical response and in the absence of adverse events after 2 weeks, consider obtaining a plasma concentration 4 hours after dosing. If response is inadequate and concentration is < 200 ng/mL, consider a proportional dose increase to achieve a concentration to approach 400 ng/mL. If unacceptable side effects are present at any time, consider a reduction in dose."
EXPECTED_CLASSIFICATION = "Strong"
EXPECTED_IMPLICATION = "CYP2D6: Significantly decreased metabolism of atomoxetine may result in higher concentrations as compared to non-poor metabolizers. This may increase the occurrence of side effects, but also a greater improvement of ADHD symptoms as compared to non-poor metabolizers in those who tolerate treatment. Poor metabolizer status is associated with lower final dose requirements as compared to non-poor metabolizers."
DRUG = "atomoxetine"
GENE = "CYP2D6"
VARIANT = "CYP2D6 0.0"
