...
EXPECTED_RECOMMENDATION = "Prescribe \u22641mg as a starting dose and adjust doses of pitavastatin based on disease-specific guidelines. If dose >1mg needed for desired efficacy, consider an alternative statin (see Figure 1 of PMID: 35152405 for recommendations for alternative statins) or combination therapy (i.e. pitavastatin plus non-statin guideline directed medical therapy)(PMID: 30423391)."
EXPECTED_CLASSIFICATION = "Moderate"
EXPECTED_IMPLICATION = "SLCO1B1: Increased pitavastatin exposure as compared to normal and decreased function which may translate to increased myopathy risk."
DRUG = "pitavastatin"
GENE = "SLCO1B1"
