...
EXPECTED_RECOMMENDATION = "Prescribe \u226440mg as a starting dose and adjust doses of atorvastatin based on disease-specific guidelines. Prescriber should be aware of possible increased risk for myopathy especially for 40mg dose. If dose >40mg needed for desired efficacy, consider combination therapy (i.e., atorvastatin plus non-statin guideline directed medical therapy) (PMID: 30423391)."
EXPECTED_CLASSIFICATION = "Moderate"
EXPECTED_IMPLICATION = "SLCO1B1: Increased atorvastatin exposure as compared to normal function which may translate to increased myopathy risk"
DRUG = "atorvastatin"
GENE = "SLCO1B1"
