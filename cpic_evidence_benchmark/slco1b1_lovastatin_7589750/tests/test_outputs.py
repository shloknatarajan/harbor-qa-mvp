...
EXPECTED_RECOMMENDATION = "Prescribe desired starting dose and adjust doses based on disease-specific guidelines."
EXPECTED_CLASSIFICATION = "Strong"
EXPECTED_IMPLICATION = "SLCO1B1: Typical myopathy risk and statin exposure"
DRUG = "lovastatin"
GENE = "SLCO1B1"
VARIANT = "SLCO1B1 Increased Function"
