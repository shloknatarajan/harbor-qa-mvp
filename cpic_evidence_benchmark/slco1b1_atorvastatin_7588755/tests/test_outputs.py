...
EXPECTED_RECOMMENDATION = "Prescribe \u226420mg as a starting dose and adjust doses of atorvastatin based on disease-specific guidelines. If dose >20mg is needed for desired efficacy, consider rosuvastatin or combination therapy (i.e., atorvastatin plus non-statin guideline directed medical therapy) (PMID: 30423391)."
EXPECTED_CLASSIFICATION = "Moderate"
EXPECTED_IMPLICATION = "SLCO1B1: Increased atorvastatin exposure as compared to normal and decreased function which may translate to increased myopathy risk."
DRUG = "atorvastatin"
GENE = "SLCO1B1"
VARIANT = "SLCO1B1 Poor Function"
