...
EXPECTED_RECOMMENDATION = "Prescribe an alternative statin depending on the desired potency (see Figure 1 of PMID: 35152405 for recommendations for alternative statins). If lovastatin therapy is warranted, limit dose to \u226420mg/day."
EXPECTED_CLASSIFICATION = "Moderate"
EXPECTED_IMPLICATION = "SLCO1B1: Increased lovastatin acid exposure as compared to normal function which may translate to increased myopathy risk"
DRUG = "lovastatin"
GENE = "SLCO1B1"
