...
**Variant:** TPMT*1, TPMT*2, TPMT*3A, TPMT*3B, TPMT*3C, TPMT*9
**Gene:** TPMT
...
Your task is to read through the papers and identify the following information about **TPMT*1, TPMT*2, TPMT*3A, TPMT*3B, TPMT*3C, TPMT*9** in gene **TPMT**:
...
3. **Relevant paper count**: How many of the papers in `/app/papers/` are relevant to TPMT*1, TPMT*2, TPMT*3A, TPMT*3B, TPMT*3C, TPMT*9?
...
- The papers directory contains 16 papers total. Count only those relevant to TPMT*1, TPMT*2, TPMT*3A, TPMT*3B, TPMT*3C, TPMT*9.