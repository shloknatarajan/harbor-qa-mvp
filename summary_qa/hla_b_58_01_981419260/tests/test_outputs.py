...
EXPECTED_DRUGS = ["allopurinol"]
EXPECTED_PHENOTYPES = ["drug hypersensitivity", "drug reaction with eosinophilia and systemic symptoms", "severe cutaneous adverse reactions", "stevens-johnson syndrome", "toxic epidermal necrolysis"]
EXPECTED_RELEVANT_PAPER_COUNT = 9
