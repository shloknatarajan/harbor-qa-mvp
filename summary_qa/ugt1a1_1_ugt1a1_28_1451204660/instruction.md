...
Your task is to read through the papers and identify the following information about **UGT1A1*1, UGT1A1*28** in gene **UGT1A1**:
...
3. **Relevant paper count**: How many of the papers in `/app/papers/` are relevant to UGT1A1*1, UGT1A1*28?
...
- The papers directory contains 22 papers total. Count only those relevant to UGT1A1*1, UGT1A1*28.
