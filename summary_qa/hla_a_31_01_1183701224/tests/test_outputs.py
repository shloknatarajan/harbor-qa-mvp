...
EXPECTED_DRUGS = ["carbamazepine"]
EXPECTED_PHENOTYPES = ["drug hypersensitivity", "drug reaction with eosinophilia and systemic symptoms", "maculopapular exanthema", "stevens-johnson syndrome", "toxic epidermal necrolysis"]
EXPECTED_RELEVANT_PAPER_COUNT = 6
