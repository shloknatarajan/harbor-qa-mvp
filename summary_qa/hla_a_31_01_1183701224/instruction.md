...
Your task is to read through the papers and identify the following information about **HLA-A*31:01** in gene **HLA-A**:
...
3. **Relevant paper count**: How many of the papers in `/app/papers/` are relevant to HLA-A*31:01?
...
- The papers directory contains 16 papers total. Count only those relevant to HLA-A*31:01.
