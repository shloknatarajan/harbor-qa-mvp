...
Your task is to read through the papers and identify the following information about **rs12979860** in gene **IFNL3;IFNL4**:
...
3. **Relevant paper count**: How many of the papers in `/app/papers/` are relevant to rs12979860?
...
- The papers directory contains 15 papers total. Count only those relevant to rs12979860.