...
Your task is to read through the papers and identify the following information about **rs113993960** in gene **CFTR**:
...
3. **Relevant paper count**: How many of the papers in `/app/papers/` are relevant to rs113993960?
...
- The papers directory contains 14 papers total. Count only those relevant to rs113993960.