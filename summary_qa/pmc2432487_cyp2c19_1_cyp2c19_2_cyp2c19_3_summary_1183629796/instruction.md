...
**Variant:** CYP2C19*1, CYP2C19*2, CYP2C19*3
**Gene:** CYP2C19
...
Your task is to read through the papers and identify the following information about **CYP2C19*1, CYP2C19*2, CYP2C19*3** in gene **CYP2C19**:
...
3. **Relevant paper count**: How many of the papers in `/app/papers/` are relevant to CYP2C19*1, CYP2C19*2, CYP2C19*3?
...
- The papers directory contains 13 papers total. Count only those relevant to CYP2C19*1, CYP2C19*2, CYP2C19*3.