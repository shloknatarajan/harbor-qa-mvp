...
EXPECTED_DRUGS = ["phenytoin"]
EXPECTED_PHENOTYPES = ["drug reaction with eosinophilia and systemic symptoms", "severe cutaneous adverse reactions", "stevens-johnson syndrome", "toxic epidermal necrolysis"]
