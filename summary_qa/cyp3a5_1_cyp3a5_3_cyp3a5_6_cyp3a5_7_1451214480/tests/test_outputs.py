...
EXPECTED_PHENOTYPES = ["heart transplantation", "hematopoietic stem cell transplantation", "kidney transplantation", "lung transplantation"]
EXPECTED_RELEVANT_PAPER_COUNT = 35
