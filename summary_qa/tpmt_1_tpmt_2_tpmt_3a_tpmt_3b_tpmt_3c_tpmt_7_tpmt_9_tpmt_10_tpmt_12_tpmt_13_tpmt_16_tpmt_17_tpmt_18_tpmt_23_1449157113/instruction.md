...
**Variant:** TPMT*1, TPMT*2, TPMT*3A, TPMT*3B, TPMT*3C, TPMT*7, TPMT*9, TPMT*10, TPMT*12, TPMT*13, TPMT*16, TPMT*17, TPMT*18, TPMT*23
**Gene:** TPMT
...
Your task is to read through the papers and identify the following information about **TPMT*1, TPMT*2, TPMT*3A, TPMT*3B, TPMT*3C, TPMT*7, TPMT*9, TPMT*10, TPMT*12, TPMT*13, TPMT*16, TPMT*17, TPMT*18, TPMT*23** in gene **TPMT**:
...
3. **Relevant paper count**: How many of the papers in `/app/papers/` are relevant to TPMT*1, TPMT*2, TPMT*3A, TPMT*3B, TPMT*3C, TPMT*7, TPMT*9, TPMT*10, TPMT*12, TPMT*13, TPMT*16, TPMT*17, TPMT*18, TPMT*23?
...
- The papers directory contains 12 papers total. Count only those relevant to TPMT*1, TPMT*2, TPMT*3A, TPMT*3B, TPMT*3C, TPMT*7, TPMT*9, TPMT*10, TPMT*12, TPMT*13, TPMT*16, TPMT*17, TPMT*18, TPMT*23.
