...
Your task is to read through the papers and identify the following information about **rs78655421** in gene **CFTR**:
...
3. **Relevant paper count**: How many of the papers in `/app/papers/` are relevant to rs78655421?
...
- The papers directory contains 12 papers total. Count only those relevant to rs78655421.