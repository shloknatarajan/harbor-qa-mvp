...
Your task is to read through the papers and identify the following information about **HLA-B*15:02** in gene **HLA-B**:
...
3. **Relevant paper count**: How many of the papers in `/app/papers/` are relevant to HLA-B*15:02?
...
- The papers directory contains 12 papers total. Count only those relevant to HLA-B*15:02.
