...
**Variant:** NUDT15*1, NUDT15*2, NUDT15*3
**Gene:** NUDT15
...
Your task is to read through the papers and identify the following information about **NUDT15*1, NUDT15*2, NUDT15*3** in gene **NUDT15**:
...
3. **Relevant paper count**: How many of the papers in `/app/papers/` are relevant to NUDT15*1, NUDT15*2, NUDT15*3?
...
- The papers directory contains 11 papers total. Count only those relevant to NUDT15*1, NUDT15*2, NUDT15*3.
