...
EXPECTED_IMPLICATION = "MT-RNR1: Weak or no evidence for an increased risk of MT-RNR1 associated hearing loss if administered an aminoglycoside antibiotic."
DRUG = "gentamicin"
GENE = "MT-RNR1"
VARIANT = "MT-RNR1 uncertain risk of aminoglycoside-induced hearing loss"
