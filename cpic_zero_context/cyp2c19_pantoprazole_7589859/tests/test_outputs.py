...
EXPECTED_ACTION_CATEGORY = "monitor"
EXPECTED_CLASSIFICATION = "Moderate"
EXPECTED_KEY_TERMS = ["monitor", "100%"]
EXPECTED_RECOMMENDATION = "Initiate standard starting daily dose. Consider increasing dose by 50-100% for the treatment of H. pylori infection and erosive esophagitis. Daily dose may be given in divided doses.\\nMonitor for efficacy."
