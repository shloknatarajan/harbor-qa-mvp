...
EXPECTED_KEY_TERMS = []
EXPECTED_RECOMMENDATION = "To ascertain G6PD status, enzyme activity must be measured. Drug use should be guided per the recommendations based on the activity-based phenotype."
