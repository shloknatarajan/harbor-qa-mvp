...
EXPECTED_ACTION_CATEGORY = "dose_reduction"
EXPECTED_CLASSIFICATION = "Strong"
EXPECTED_KEY_TERMS = ["reduce starting dose", "50% reduction", "monitor", "50%"]
EXPECTED_RECOMMENDATION = "Reduce starting dose by 50% followed by titration of dose based on toxicity or therapeutic drug monitoring (if available). Patients with the c.2846A>T/c.2846A>T genotype may require >50% reduction in starting dose."
