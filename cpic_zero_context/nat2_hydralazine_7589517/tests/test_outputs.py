...
EXPECTED_ACTION_CATEGORY = "other"
EXPECTED_CLASSIFICATION = "Moderate"
EXPECTED_KEY_TERMS = ["100%"]
EXPECTED_RECOMMENDATION = "Consider a starting total daily dose of at least 75 mg. Titrate up to 300 mg total daily hydralazine dose as tolerated. NAT2 intermediate metabolizers typically require a 50-100% higher maintenance dose compared to poor metabolizers."
