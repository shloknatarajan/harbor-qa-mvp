...
EXPECTED_KEY_TERMS = ["reduce starting dose", "monitor", "50%"]
EXPECTED_RECOMMENDATION = "Reduce starting dose by 50% followed by titration of dose based on toxicity or therapeutic drug monitoring (if available)."
