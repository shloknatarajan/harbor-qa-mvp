...
EXPECTED_ACTION_CATEGORY = "avoid"
EXPECTED_CLASSIFICATION = "Strong"
EXPECTED_KEY_TERMS = ["avoid", "alternative"]
EXPECTED_RECOMMENDATION = "Avoid aminoglycoside anitbiotics unless the high risk of permanent hearing loss is outweighed by the severity of infection and lack of safe or effective alternative therapies."
