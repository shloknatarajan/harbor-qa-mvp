...
EXPECTED_KEY_TERMS = ["alternative", "select alternative"]
EXPECTED_RECOMMENDATION = "Select alternative drug not predominantly metabolized by CYP2D6 (i.e., granisetron)."
