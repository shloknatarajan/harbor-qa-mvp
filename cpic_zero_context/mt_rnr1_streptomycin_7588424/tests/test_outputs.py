...
EXPECTED_IMPLICATION = "MT-RNR1: Very high risk of developing hearing loss if administered an aminoglycoside antibiotic."
DRUG = "streptomycin"
GENE = "MT-RNR1"
VARIANT = "MT-RNR1 increased risk of aminoglycoside-induced hearing loss"
