...
EXPECTED_ACTION_CATEGORY = "dose_increase"
EXPECTED_CLASSIFICATION = "Moderate"
EXPECTED_KEY_TERMS = ["dose increase"]
EXPECTED_RECOMMENDATION = "Initiate with a dose of 0.5 mg/kg/day and if no clinical response and in the absence of adverse events after 2 weeks, consider obtaining a plasma concentration 2 to 4 hours after dosing. If response is inadequate and concentration is < 200 ng/mL, consider a proportional dose increase to achieve a concentration to approach 400 ng/mL. If unacceptable side effects are present at any time, consider a reduction in dose."


# Action category keyword mapping
ACTION_KEYWORDS = {
    "avoid": ["contraindicated", "not recommended", "avoid", "do not use"],
    "standard_dosing": ["per standard dosing", "standard dosing", "at standard doses", "standard dose", "label-recommended"],
    "dose_reduction": ["reduce dose", "reduced dose", "decrease dose", "decreased dose", "lower dose", "dose decrease", "dose reduction", "50% reduction", "50% of standard"],
    "dose_increase": ["increase dose", "increased dose", "higher dose", "dose increase"],
