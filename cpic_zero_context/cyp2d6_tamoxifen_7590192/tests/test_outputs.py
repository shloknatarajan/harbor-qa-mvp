...
EXPECTED_KEY_TERMS = ["avoid"]
EXPECTED_RECOMMENDATION = "Avoid moderate and strong CYP2D6 inhibitors. Initiate therapy with recommended standard of care dosing (tamoxifen 20 mg/day)."
