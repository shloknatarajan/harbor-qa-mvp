...
EXPECTED_KEY_TERMS = ["at standard doses", "standard dose", "monitor", "caution"]
EXPECTED_RECOMMENDATION = "Use at standard doses with caution and with close monitoring for anemia"
