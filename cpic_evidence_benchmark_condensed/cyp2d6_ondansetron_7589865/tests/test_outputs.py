...
EXPECTED_IMPLICATION = "CYP2D6: Increased metabolism to less active compounds when compared to normal metabolizers and is associated with decreased response to ondansetron and tropisetron (i.e. vomiting)."
DRUG = "ondansetron"
GENE = "CYP2D6"
VARIANT = "CYP2D6 \u22656.0"
