...
EXPECTED_RECOMMENDATION = "Avoid tricyclic use due to potential for side effects. Consider alternative drug not metabolized by CYP2D6. If a tricyclic antidepressant is warranted, consider a 50% reduction of recommended starting dose. Titrate dose to observed clinical response with symptom improvement and minimal (if any) side effects. Utilize therapeutic drug monitoring to guide dose adjustments."
EXPECTED_CLASSIFICATION = "Strong"
EXPECTED_IMPLICATION = "CYP2D6: Greatly reduced metabolism of tricyclic antidepressants to less active compounds compared to normal metabolizers. Higher plasma concentrations of active drug will increase the probability of side effects."
DRUG = "nortriptyline"
GENE = "CYP2D6"
VARIANT = "CYP2D6 0.0"
