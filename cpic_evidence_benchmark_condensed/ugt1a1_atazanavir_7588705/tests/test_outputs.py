...
EXPECTED_RECOMMENDATION = "Consider an alternative agent particularly where jaundice would be of concern to the patient. If atazanavir is to be prescribed, there is a high likelihood of developing jaundice that will result in atazanavir discontinuation (at least 20% and as high as 60%)."
EXPECTED_CLASSIFICATION = "Strong"
EXPECTED_IMPLICATION = "UGT1A1: Markedly decreased UGT1A1 activity; high likelihood of bilirubin-related discontinuation of atazanavir."
DRUG = "atazanavir"
GENE = "UGT1A1"
VARIANT = "UGT1A1 Poor Metabolizer"
