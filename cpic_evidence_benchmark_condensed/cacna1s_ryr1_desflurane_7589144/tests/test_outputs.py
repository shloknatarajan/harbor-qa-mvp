...
EXPECTED_RECOMMENDATION = "No CACNA1S genotype is available. Based on RYR1 status, clinical findings, family history, further genetic testing and other laboratory data should guide use of halogenated volatile anesthetics or depolarizing muscle relaxants."
EXPECTED_CLASSIFICATION = "Strong"
EXPECTED_IMPLICATION = "RYR1: These results do not eliminate the chance that this patient is susceptible to malignant hyperthermia (MH). The genetic cause of about half of all MH survivors, with MH susceptibility confirmed by contracture test, remains unknown (PMID 28902675).; CACNA1S: n/a"
DRUG = "desflurane"
GENE = "CACNA1S|RYR1"
VARIANT = "RYR1 Uncertain Susceptibility; CACNA1S No Result"
