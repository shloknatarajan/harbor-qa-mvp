...
EXPECTED_RECOMMENDATION = "Initiate with a dose of 40 mg/day and if no clinical response and in the absence of adverse events after 2 weeks increase dose to 80 mg/day. If response is inadequate after 2 weeks consider obtaining a plasma concentration 2-4 h after dosing. If concentration is <200 ng/mL, consider a proportional dose increase to achieve a concentration to approach 400 ng/mL. If unacceptable side effects are present at any time, consider a reduction in dose."
EXPECTED_CLASSIFICATION = "Moderate"
EXPECTED_IMPLICATION = "CYP2D6: Decreased metabolism of atomoxetine and higher atomoxetine concentrations as compared to normal metabolizers. Individuals with activity score of 1.0 with CYP2D6*10 may be at an increased risk of discontinuation as compared to poor metabolizers."
DRUG = "atomoxetine"
GENE = "CYP2D6"
VARIANT = "CYP2D6 0.75"
