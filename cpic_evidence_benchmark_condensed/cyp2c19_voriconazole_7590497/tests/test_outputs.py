...
EXPECTED_RECOMMENDATION = "Initiate therapy with recommended standard of care dosing. Use therapeutic drug monitoring to titrate dose to therapeutic trough concentrations."
EXPECTED_CLASSIFICATION = "Moderate"
EXPECTED_IMPLICATION = "CYP2C19: In patients for whom a rapid metabolizer genotype (*1/*17) is identified, the probability of attainment of therapeutic concentrations is variable."
DRUG = "voriconazole"
GENE = "CYP2C19"
VARIANT = "CYP2C19 Rapid Metabolizer"
