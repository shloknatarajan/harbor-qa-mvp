...
EXPECTED_RECOMMENDATION = "Initiate therapy at a total daily dose of 40 to 75 mg. Carefully titrate dose upward to clinical effect or guideline-recommended dose; use caution with total daily hydralazine doses of 200 mg or more."
EXPECTED_CLASSIFICATION = "Moderate"
EXPECTED_IMPLICATION = "NAT2: Predicted to have increased hydralazine plasma concentrations compared to NAT2 rapid and intermediate metabolizers, which may lead to both increased efficacy and adverse effects, including drug-induced systemic lupus erythematosus."
DRUG = "hydralazine"
GENE = "NAT2"
VARIANT = "NAT2 Poor Metabolizer"
