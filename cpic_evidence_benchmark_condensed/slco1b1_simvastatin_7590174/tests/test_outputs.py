...
EXPECTED_RECOMMENDATION = "Prescribe an alternative statin depending on the desired potency (see Figure 1 of PMID: 35152405 for recommendations for alternative statins). If simvastatin therapy is warranted, limit dose to <20mg/day."
EXPECTED_CLASSIFICATION = "Strong"
EXPECTED_IMPLICATION = "SLCO1B1: Increased simvastatin acid exposure as compared to normal function; increased risk of myopathy"
DRUG = "simvastatin"
GENE = "SLCO1B1"
