...
EXPECTED_RECOMMENDATION = "Prescribe desired starting dose and adjust doses of pravastatin based on disease-specific guidelines. Prescriber should be aware of possible increased risk for myopathy with pravastatin especially with doses >40mg per day."
EXPECTED_CLASSIFICATION = "Moderate"
EXPECTED_IMPLICATION = "SLCO1B1: Increased pravastatin exposure as compared to normal function; Typical myopathy risk with doses \u226440 mg."
DRUG = "pravastatin"
GENE = "SLCO1B1"
VARIANT = "SLCO1B1 Possible Decreased Function"
