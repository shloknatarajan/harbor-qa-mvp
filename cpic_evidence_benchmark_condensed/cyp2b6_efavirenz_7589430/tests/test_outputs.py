...
EXPECTED_IMPLICATION = "CYP2B6: Slightly lower dose-adjusted trough concentrations of efavirenz compared with normal metabolizers"
DRUG = "efavirenz"
GENE = "CYP2B6"
VARIANT = "CYP2B6 Ultrarapid Metabolizer"
