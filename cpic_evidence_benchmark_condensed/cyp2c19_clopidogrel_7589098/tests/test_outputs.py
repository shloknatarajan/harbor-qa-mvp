...
EXPECTED_RECOMMENDATION = "Avoid clopidogrel if possible. Consider an alternative P2Y12 inhibitor at standard dose if clinically indicated and no contraindication."
EXPECTED_CLASSIFICATION = "Moderate"
EXPECTED_IMPLICATION = "CYP2C19: Significantly reduced clopidogrel active metabolite formation; increased on-treatment platelet reactivity; increased risk for adverse cardiac and cerebrovascular events"
DRUG = "clopidogrel"
GENE = "CYP2C19"
